...
<div class="screen" id="screen-theme-picker" style="padding-top:0;">
  <div style="text-align:center;max-width:380px;width:100%;padding:40px 16px 0;">
    ...
    <div class="tagline" id="lbl-tagline" data-i18n="tagline">Apprends. Investis. Maîtrise.</div>
    <p style="font-weight:800;font-size:1rem;margin-top:8px;" id="lbl-pick-theme" data-i18n="pick_theme">Choisis ton thème</p>
    <div class="theme-pick-grid">
      <button class="theme-pick-btn" onclick="pickTheme('dark')">
        <div class="theme-pick-icon">🌙</div><div class="theme-pick-name" id="lbl-theme-dark" data-i18n="theme_dark">Sombre</div>
      </button>
      <button class="theme-pick-btn" onclick="pickTheme('light')">
        <div class="theme-pick-icon">☀️</div><div class="theme-pick-name" id="lbl-theme-light" data-i18n="theme_light">Clair</div>
      </button>
      <button class="theme-pick-btn" onclick="pickTheme('claude')">
        <div class="theme-pick-icon">🤖</div><div class="theme-pick-name" id="lbl-theme-claude" data-i18n="theme_claude">Claude</div>
      </button>
      <button class="theme-pick-btn" onclick="pickTheme('random')">
        <div class="theme-pick-icon">🎲</div><div class="theme-pick-name" id="lbl-theme-random" data-i18n="theme_random">Aléatoire</div>
      </button>
    </div>
  </div>
</div>
...
<div class="screen active" id="screen-auth" style="justify-content:center;padding-top:40px;">
  <div style="text-align:center;margin-bottom:8px;">
    ...
    <div class="logo">LinguaQuest</div>
    <div class="tagline" id="lbl-tagline-auth" data-i18n="tagline">Apprends. Investis. Maîtrise.</div>
  </div>
  <div class="auth-card card-accent">
    ...
    <div id="form-login">
      ...
      <label class="auth-label" id="lbl-login-pass" data-i18n="lbl_pass">Mot de passe</label>
      <div class="pass-wrap">
      ...
      <div style="text-align:right;margin:-4px 0 10px;">
        <span class="forgot-link" onclick="openForgot()" id="lbl-forgot-link" data-i18n="forgot_link">Mot de passe oublié ?</span>
      </div>
      <div class="auth-error" id="login-err"></div>
      <button class="btn btn-primary" style="width:100%;justify-content:center;" onclick="doLogin()" id="btn-do-login" data-i18n="btn_login">Se connecter →</button>
    ...
    <div id="form-register" style="display:none;">
      <label class="auth-label" id="lbl-reg-name" data-i18n="lbl_reg_name">Prénom / Pseudo</label>
      <input class="auth-input" type="text" id="reg-name" placeholder="Marie" onkeydown="if(event.key==='Enter')doRegister()">
      <label class="auth-label" id="lbl-reg-email" data-i18n="lbl_reg_email">Email</label>
      <input class="auth-input" type="email" id="reg-email" placeholder="ton@email.com" onkeydown="if(event.key==='Enter')doRegister()">
      <label class="auth-label" id="lbl-reg-pass" data-i18n="lbl_reg_pass">Mot de passe</label>
      <div class="pass-wrap">
    ...
    <div style="display:flex;align-items:center;gap:10px;margin:18px 0 14px;">
      ...
      <span style="font-size:.72rem;color:var(--muted);white-space:nowrap;" id="lbl-or-guest" data-i18n="or_guest">ou continuer sans compte</span>
      <div style="flex:1;height:1px;background:rgba(255,255,255,.08);"></div>
    </div>
    <button class="btn btn-secondary" style="width:100%;justify-content:center;gap:8px;" id="btn-guest" onclick="guestLogin()"><span id="lbl-guest-btn" data-i18n="guest_btn">👤 Continuer en invité</span></button>
    <div style="text-align:center;margin-top:8px;font-size:.7rem;color:var(--muted);" id="lbl-guest-warn" data-i18n="guest_warn">La progression ne sera pas sauvegardée</div>
...
<div id="nav-bar" class="nav-bar" style="display:none;">
  <div class="nav-item active" id="nav-learn" onclick="navTo('learn')"><span class="ni" style="font-size:1.1rem;font-weight:900;color:inherit;">A</span><span id="lbl-nav-learn" data-i18n="nav_learn">Apprendre</span></div>
  <div class="nav-item" id="nav-portfolio" onclick="navTo('portfolio')"><span class="ni" style="font-size:1.2rem;font-weight:900;color:inherit;">$</span><span id="lbl-nav-portfolio" data-i18n="nav_portfolio">Portfolio</span></div>
  ...
  <div class="nav-item" id="nav-shop" onclick="navTo('shop')"><span class="ni" style="font-size:1.2rem;font-weight:900;color:inherit;">★</span><span id="lbl-nav-shop" data-i18n="nav_shop">Boutique</span></div>
  <div class="nav-item" id="nav-profile" onclick="navTo('profile')"><span class="ni" style="font-size:1.2rem;font-weight:900;color:inherit;">◉</span><span id="lbl-nav-profile" data-i18n="nav_profile">Profil</span></div>
</div>
...
<div class="screen screen-padded" id="screen-learn">
  ...
  <div style="text-align:center;margin:4px 0 12px;">
    ...
    <div class="tagline" style="margin-bottom:0;" id="lbl-learn-tagline" data-i18n="learn_tagline">Choisis ta langue</div>
  </div>
  <div class="steps-row">
  ...
  <div class="lang-section">
    <div class="lang-section-title" id="lbl-i-speak" data-i18n="i_speak">🧑 Je parle</div>
  ...
  <div class="lang-section" id="target-section" style="opacity:.38;transition:opacity .3s;">
    <div class="lang-section-title" id="lbl-i-learn" data-i18n="i_learn">🎯 Je veux apprendre</div>
...
<div class="screen screen-padded" id="screen-levels">
  ...
  <div class="section-sub" id="lbl-levels-sub" data-i18n="levels_sub">Affronte les monstres, bats le boss, maîtrise la langue</div>
...
<div class="screen screen-padded" id="screen-game-select">
  ...
  <div style="display:flex;justify-content:flex-end;width:100%;max-width:700px;margin-bottom:7px;">
    <span class="mix-badge" id="lbl-mix-badge" data-i18n="mix_badge">🎲 Mode Mixte recommandé</span>
  </div>
  <div style="display:flex;gap:8px;margin-bottom:12px;width:100%;max-width:700px;">
    <button class="btn-qr" onclick="openFlappyQR()" style="flex:1;justify-content:center;">
      🐦 QR Flappy Bird
    </button>
  ...
  <div class="game-types">
    ...
    <div class="game-type-card featured" onclick="startGame('mixed')">
      <div class="game-icon">🎲</div><div class="game-type-name" id="lbl-gtype-mixed" data-i18n="gtype_mixed">Mode Mixte</div>
    ...
    <div class="game-type-card" onclick="startGame('quiz')">
      <div class="game-icon">⚡</div><div class="game-type-name" id="lbl-gtype-quiz" data-i18n="gtype_quiz">Quiz Rapide</div>
    ...
    <div class="game-type-card" onclick="startGame('fill')">
      <div class="game-icon">✏️</div><div class="game-type-name" id="lbl-gtype-fill" data-i18n="gtype_fill">Compléter</div>
    ...
    <div class="game-type-card" onclick="startGame('match')">
      <div class="game-icon">🔗</div><div class="game-type-name" id="lbl-gtype-match" data-i18n="gtype_match">Associer</div>
...
<div class="screen screen-padded" id="screen-results">
  <div style="text-align:center;width:100%;max-width:520px;padding:20px 0;">
    ...
    <div style="display:flex;gap:8px;justify-content:center;flex-wrap:wrap;">
      <button class="btn btn-primary" onclick="playAgain()" id="btn-replay" data-i18n="btn_replay">Rejouer 🔄</button>
      <button class="btn btn-secondary" onclick="goTo('chapters')" id="btn-r-chapters" data-i18n="btn_r_chapters">Chapitres</button>
      <button class="btn btn-gold" onclick="navTo('portfolio')" id="btn-r-invest" data-i18n="btn_r_invest">$ Investir</button>
    </div>
...
<div class="screen screen-padded" id="screen-lesson">
  ...
  <div class="lesson-complete-card" id="lesson-complete" style="display:none;">
    ...
    <button class="btn btn-primary" id="lesson-done-back" onclick="navTo('portfolio')" data-i18n="lesson_back">← Retour au Portfolio</button>
  </div>
...
<div class="academy-section" id="academy-section">
    <button class="academy-toggle-btn" id="academy-toggle" onclick="toggleAcademy()">
      🎓 <span id="lbl-academy-title" data-i18n="academy_title">Finance Academy</span>
...
<div class="screen screen-padded" id="screen-shop">
  <div class="section-title" id="lbl-shop-title" data-i18n="shop_title">🛍 Boutique</div>
...
<div class="screen screen-padded" id="screen-profile">
  ...
  <div style="width:100%;max-width:700px;margin-top:14px;">
    ...
    <!-- Apparence / Thèmes -->
    <div style="background:var(--card);border:1px solid rgba(255,255,255,.08);border-radius:16px;padding:16px;margin-bottom:10px;">
      <div style="font-weight:800;font-size:.88rem;margin-bottom:10px;" id="lbl-appearance" data-i18n="appearance">🎨 Apparence</div>
      ...
      <!-- UI Language -->
      <div style="font-weight:800;font-size:.88rem;margin-bottom:8px;margin-top:12px;" id="lbl-lang-ui" data-i18n="lang_ui">🌐 Langue de l'interface</div>
      <div class="lang-ui-btns" id="ui-lang-btns"></div>
    </div>
    <button class="btn btn-secondary" style="width:100%;justify-content:center;margin-bottom:10px;" onclick="openLangModal()" id="btn-change-lang" data-i18n="btn_change_lang">🌍 Changer de langue</button>
    <button class="btn btn-secondary" style="width:100%;justify-content:center;" onclick="doLogout()" id="btn-logout" data-i18n="btn_logout">🚪 Se déconnecter</button>
  </div>
</div>
...
<div class="modal-overlay" id="qr-modal" style="display:none;" onclick="closeQR(event)">
  <div class="modal-box" onclick="event.stopPropagation()">
    ...
    <div style="font-size:1.1rem;font-weight:800;margin-bottom:4px;" id="lbl-qr-title" data-i18n="qr_title">📱 Partager ce chapitre</div>
    ...
    <div style="display:flex;gap:8px;justify-content:center;">
      <button class="btn btn-primary btn-sm" onclick="copyUrl()" id="btn-qr-copy" data-i18n="btn_qr_copy">📋 Copier</button>
...
<div class="modal-overlay" id="lang-modal" style="display:none;" onclick="closeLangModal(event)">
  <div class="modal-box" onclick="event.stopPropagation()" style="max-width:420px;">
    ...
    <div style="font-size:1.1rem;font-weight:800;margin-bottom:4px;" id="lbl-langmodal-title" data-i18n="langmodal_title">Changer de langue</div>
    <div style="font-size:.8rem;color:var(--muted);margin-bottom:4px;" id="lbl-lm-speak" data-i18n="lm_speak">Je parle :</div>
    ...
    <div style="display:flex;gap:8px;justify-content:center;">
      <button class="btn btn-primary btn-sm" onclick="applyLangChange()" id="btn-lm-apply" data-i18n="btn_apply">Appliquer</button>
      <button class="btn btn-secondary btn-sm" onclick="closeLangModal()" id="btn-lm-cancel" data-i18n="btn_cancel">Annuler</button>
    </div>
  </div>
</div>
...
<div class="modal-overlay" id="asset-modal" style="display:none;" onclick="closeAssetModal(event)">
  <div class="modal-box" onclick="event.stopPropagation()" style="max-width:460px;text-align:left;">
    ...
    <div style="display:flex;gap:8px;margin-top:14px;">
      ...
      <button class="btn btn-secondary btn-sm" onclick="closeAssetModal()" id="btn-amod-close" data-i18n="btn_close">Fermer</button>
    </div>
  </div>
</div>
...
<div class="modal-overlay" id="forgot-modal" style="display:none;" onclick="closeForgot(event)">
  <div class="modal-box" onclick="event.stopPropagation()" style="max-width:400px;">
    ...
    <div id="forgot-step-1">
      ...
      <div style="font-size:1.1rem;font-weight:800;margin-bottom:4px;" id="lbl-forgot-title" data-i18n="forgot_title">Mot de passe oublié</div>
      <div style="font-size:.8rem;color:var(--muted);margin-bottom:18px;" id="lbl-forgot-sub" data-i18n="forgot_sub">Entre ton email pour récupérer ton compte.</div>
      <label class="auth-label">Email</label>
      ...
      <button class="btn btn-primary" style="width:100%;justify-content:center;margin-top:10px;" onclick="forgotStep1()" id="btn-forgot-1" data-i18n="forgot_check">Vérifier mon compte →</button>
    </div>

    <!-- STEP 2: found account, set new password -->
    <div id="forgot-step-2" style="display:none;">
      <div style="font-size:1.5rem;text-align:center;margin-bottom:6px;">✅</div>
      <div style="font-size:1.1rem;font-weight:800;margin-bottom:4px;" id="lbl-forgot-found-title" data-i18n="forgot_found_title">Compte trouvé !</div>
      ...
      <label class="auth-label" id="lbl-forgot-new-pass" data-i18n="forgot_new_pass">Nouveau mot de passe</label>
      <div class="pass-wrap">
      ...
      <label class="auth-label" style="margin-top:10px;" id="lbl-forgot-confirm-pass" data-i18n="forgot_confirm_pass">Confirme le mot de passe</label>
      <div class="pass-wrap">
      ...
      <button class="btn btn-primary" style="width:100%;justify-content:center;margin-top:12px;" onclick="forgotStep2()" id="btn-forgot-2" data-i18n="forgot_reset">Réinitialiser →</button>
    </div>

    <!-- STEP 3: success -->
    <div id="forgot-step-3" style="display:none;text-align:center;padding:10px 0;">
      <div style="font-size:3rem;margin-bottom:10px;">🎉</div>
      <div style="font-size:1.1rem;font-weight:800;margin-bottom:6px;" id="lbl-forgot-success-title" data-i18n="forgot_success_title">Mot de passe mis à jour !</div>
      <div style="font-size:.85rem;color:var(--muted);margin-bottom:20px;" id="lbl-forgot-success-sub" data-i18n="forgot_success_sub">Tu peux maintenant te connecter avec ton nouveau mot de passe.</div>
      <button class="btn btn-primary" style="width:100%;justify-content:center;" onclick="closeForgot();switchTab('login')" id="btn-forgot-login" data-i18n="forgot_login">Se connecter →</button>
    </div>
  </div>
</div>
