...
let _flappyLevel='any', _flappyTopic='any';
...
function getWords(){
  ...
  let allowed=null;
  if(CHAPTERS&&(_flappyLevel!=='any'||_flappyTopic!=='any')){
    const ids=new Set();
